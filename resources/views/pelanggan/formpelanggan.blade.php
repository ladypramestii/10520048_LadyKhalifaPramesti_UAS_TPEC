            ...
            <div class="col-lg-12">
                <form action="{{ url('pelanggan/create', @$pelanggan->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            <input value="{{ old('alamat_email', @$pelanggan->alamat_email) }}" type="text" class="form-control" name="alamat_email" id="alamat" placeholder="Alamat Email">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            @if(!empty(@$produk->foto_pelanggan))
                            <img src="{{ Storage::url('produk/' . @$produk->foto_pelanggan) }}" class="mb-3" alt="Foto" width="100px" />
                            @endif
